...
//		logger.info(s2  + " / info");
		...
		logger.warn("warn");
		logger.error("error");
		logger.info("binding={}", org.slf4j.LoggerFactory.getILoggerFactory().getClass().getName());
